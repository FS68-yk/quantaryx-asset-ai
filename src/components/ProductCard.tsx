...
const ProductCard: React.FC<ProductCardProps> = ({ title, subtitle, icon, features, color, index }) => {
  ...
  return (
    ...
    >
      <div className="h-full gradient-card rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden border border-gray-100 dark:border-gray-700">
        <div className="p-6">
          ...
          <h3 className="text-xl font-bold mb-1 flex items-center">
            <span className="text-quantaryx-darkblue dark:text-gray-200">{title}</span>
          </h3>
          
          <p className="text-gray-500 dark:text-gray-300 italic mb-4 text-sm">{subtitle}</p>
